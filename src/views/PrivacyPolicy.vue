    ...
    section
      .content
        ...
        p Contabo GmbH does not have access to the servers nor the data that is processed (§ 6 Server-administration, Contabo's Terms & Conditions). For more information visit&nbsp;
          a.highlighted(href="https://contabo.com/agb.html", target="_blank") Contabo's Terms & Conditions.
        ...
        h2 Proccessed Data
        p The following information is processed when using Devcord:
        ol(type="I")
          li
            strong Cookie Information.&nbsp;
            | Devcord uses cookies on this website that are necessary for Matomo's analytics. The Websites and Services we provide, do not include cookies and similar tracking technologies of third parties. For more details about how we use these technologies, please see our&nbsp;
            router-link.highlighted(to="cookie-policy") Cookie Policy.
          li
            strong Log data.&nbsp;
          ...
          li
            ...
            | Your User ID is used, to track any moderation actions on your account and to be able to exclude you from the community.
        ...
        p For any data privacy related enquiries, such as requesting a copy of your information or complete deletion, please contact us via mail at&nbsp;
          a.highlighted(href="mailto:privacy@devcord.com", target="_top") privacy@devcord.com
</template>
